      ...
      <div className=" grid grid-cols-2 py-12 ">
        <div className=" ">
          ...
          <div className=" flex item-center gap-4">
            <Link
              href={"/product"}
              className="flex items-center gap-2 px-4 py-2 text-white bg-primary hover:shadow-md hover:text-slate-300 rounded-full"
            >
              Order now
              <Right />
            </Link>
            <Link
              href={"/product"}
              className="flex items-center gap-2 px-4 py-2 shadow-md hover:bg-primary hover:text-slate-200  rounded-full"
            >
              Learn more
              <More />
            </Link>
